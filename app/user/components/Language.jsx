...
function LanguageToggle() {
  ...
  return (
    <div className="relative">
      {/* Toggle button */}
      <div
        className="flex items-center justify-between gap-2 shadow-md rounded-3xl py-2 px-2 cursor-pointer"
      ...
      {/* Dropdown menu */}
      {isOpen && (
        <div className="absolute mt-2 w-full bg-[#282932] text-white rounded-lg shadow-lg">
          <div
